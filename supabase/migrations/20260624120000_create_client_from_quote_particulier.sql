-- create_client_from_quote: particulier-ondersteuning. Zonder bedrijf valt de bedrijfsnaam terug op de
-- contactpersoon (i.p.v. 'Onbekend bedrijf') en krijgt een NIEUWE client vat_status='private' (zodat de
-- onboarding niet blijft hangen). Verder identiek aan de scope-versie (needs_installation + install-order).
