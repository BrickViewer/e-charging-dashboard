-- Bij een GEDEELD object (N:M lead<->object): laat de object->klant-koppeling bij conversie
-- alleen de eigenaar zetten als die nog leeg is (eerste-eigenaar-wint). Enige wijziging t.o.v.
-- 20260702120000: "and client_id is null" op de project_locations-update.
