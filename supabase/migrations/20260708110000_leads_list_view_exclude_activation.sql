-- Activatiekosten NIET als omzet in de pipeline: bij alleen-beheer (with_installation=false)
-- is total_installation_cost de eenmalige activatie/onboarding (wordt ingehouden op de eerste
-- afrekening) — die telt niet als 'Eenmalig'. quote_value = 0 in dat geval; anders installatie+hardware.
