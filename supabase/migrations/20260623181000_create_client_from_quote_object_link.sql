-- create_client_from_quote: koppel het object ALTIJD aan de klant (voorheen alleen bij
-- with_management=true → object-wees bij offertes zonder beheer). Verder ongewijzigd.
...
begin
  ...
  -- Object ALTIJD aan de klant koppelen (was: alleen bij with_management).
